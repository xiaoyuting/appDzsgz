 ...
 *********************************************************************************
 *
 * 在使用Kit的过程中如果出现bug请及时以以下任意一种方式联系我，我会及时修复bug
 *
...
#define NetManagerShare [NetManager sharedNetManager]

#define Weak  __weak __typeof(self) weakSelf = self

/*! 过期属性或方法名提醒 */
#define NetManagerDeprecated(instead) __deprecated_msg(instead)
...
/*! 定义上传进度 block */
typedef void( ^ UploadProgressBlock)(int64_t bytesProgress,
...
// @return URLSessionTask
// */
//+ (URLSessionTask *)_request_GETWithUrlString:(NSString *)urlString
...
// @return URLSessionTask
// */
//+ (URLSessionTask *)_request_POSTWithUrlString:(NSString *)urlString
//isNeedCache:(BOOL)isNeedCache
//parameters:(id)parameters
//successBlock:(ResponseSuccessBlock)successBlock
//failureBlock:(ResponseFailBlock)failureBlock
...
// @return URLSessionTask
// */
//+ (URLSessionTask *)_request_PUTWithUrlString:(NSString *)urlString
//parameters:(id)parameters
//successBlock:(ResponseSuccessBlock)successBlock
//failureBlock:(ResponseFailBlock)failureBlock
//progressBlock:(DownloadProgressBlock)progressBlock;
...
// @return URLSessionTask
// */
//+ (URLSessionTask *)_request_DELETEWithUrlString:(NSString *)urlString
//parameters:(id)parameters
//successBlock:(ResponseSuccessBlock)successBlock
//failureBlock:(ResponseFailBlock)failureBlock
//progressBlock:(DownloadProgressBlock)progressBlock;
...
// @return URLSessionTask
// */
//+ (URLSessionTask *)_uploadImageWithUrlString:(NSString *)urlString
//parameters:(id)parameters
...
// @param progressBlock 上传的进度
// */
//+ (void)_uploadVideoWithUrlString:(NSString *)urlString
//parameters:(id)parameters
...
// @return URLSessionTask
// */
//+ (URLSessionTask *)_downLoadFileWithUrlString:(NSString *)urlString
//parameters:(id)parameters
...
// @return URLSessionTask
// */
//+ (URLSessionTask *)_uploadFileWithUrlString:(NSString *)urlString
//parameters:(id)parameters
